...
List agent run metadata stored in the local CodeMesh home through the Agent Run Contract projection, including run ID, project alias, base, profile, lifecycle state, creation time, and workspace path.
