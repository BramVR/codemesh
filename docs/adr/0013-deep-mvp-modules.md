---
summary: "Accepted deep MVP module boundaries for Project Registry, Readiness, Agent Prep, and Env Readiness."
read_when:
  - Changing module ownership, Project Registry, Readiness, Agent Prep, Env Readiness, command adapters, or cross-module contracts.
---
