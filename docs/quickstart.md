...
For the full command list, continue to [Command Catalog](commands.md). Direct references: [init](commands/init.md), [add](commands/add.md), [scan](commands/scan.md), [tree](commands/tree.md), [status](commands/status.md), [doctor](commands/doctor.md), [hydrate](commands/hydrate.md), [access](commands/access.md), [env bind](commands/env-bind.md), [agent prepare](commands/agent-prepare.md), [runs](commands/runs.md), and [clean](commands/clean.md).
