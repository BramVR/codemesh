...
- Public docs and proof lanes: command catalog, north-star Vision, reimagined docs-site hero, source/packaged e2e, live GitHub smoke, desktop smoke, cross-OS CI, and Crabbox-style PR proof.
